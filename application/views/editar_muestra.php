...
<div class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
    <div class="panel panel-info">
        <div class="panel-heading">
            <div class="panel-title">Editar de muestra</div>
            ...
            <div style="padding-top:30px" class="panel-body" >
                ...
                <form method="post" action="<?= base_url('Muestras/guardar') ?>" class="form-horizontal" role="form">
                    ...
                    <div style="margin-bottom: 25px" class="input-group">
                        ...
                        <input type="date" class="form-control" name="fecha" value="<?=$muestra->fechaRecepcion ?>" required>
                    </div>
                    <div style="margin-bottom: 25px" class="input-group">
                        <input type="text" class="form-control" name="temp" value="<?= $muestra->temperaturaMuestra ?>" placeholder="Temperatura muestra" required>                                        
                    </div>
                    <div style="margin-bottom: 25px" class="input-group">
                        <input type="number" class="form-control" name="cantidad" value="<?= $muestra->cantidadMuestra ?>" placeholder="Cantidad de muestra" required>                                        
                    </div>
                    <div style="margin-bottom: 25px" class="input-group">
